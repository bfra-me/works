...
- Updated dependency `sort-package-json` to `3.2.0`. ([#1243](https://github.com/bfra-me/works/pull/1243))


- Updated dependency `sort-package-json` to `3.2.1`. ([#1256](https://github.com/bfra-me/works/pull/1256))
